...
Beyond the deterministic checks, [drift reviews](/cicd/drift/) look at each pull request and ask whether the code has moved away from what the threat model claims.
